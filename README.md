...
Structure:
- `/projects` – Hands-on AWS & Terraform builds
- `/notes` – Short reflections and learning summaries
...
If you’re hiring for junior cloud or security roles, this repo is my living resume.
